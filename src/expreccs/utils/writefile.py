...
Mako templates are populated from the shared expreccs configuration. The module
also writes compact repeated-value keywords, saturation-function tables,
regional multiplier files, derived schedules, and workflow-specific directory
structures.
"""
...
def write_properties(dic):
    """Build regional and site report schedules.
...
def write_folders(dic):
    """Create workflow-specific output folders.
