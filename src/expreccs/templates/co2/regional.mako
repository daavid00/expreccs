...
WELLDIMS
${len(dic['regional_wellijk'])} ${dic['site_noCells'][2]} ${len(dic['regional_wellijk'])} ${len(dic['regional_wellijk'])} /
...
COMPDAT
% for i in range(len(dic['regional_wellijk'])):
	'INJ${i}'	${dic['regional_wellijk'][i][0]}	${dic['regional_wellijk'][i][1]}	1	${dic['reference_noCells'][2]}	'OPEN'	1*	1*	0.5 /
% endfor
/
